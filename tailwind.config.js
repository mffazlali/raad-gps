...
export default {
  ...
  theme: {
    ...
    colors: ({colors}) => ({
      ...
      'primary-disable': 'var(--color-primary-disable)',
      ...
      'theme-danger': 'var(--color-theme-danger)',
      'theme-danger-hover': 'var(--color-theme-danger-hover)',
      'theme-danger-active': 'var(--color-theme-danger-active)',
      'theme-secondary': 'var(--color-theme-secondary)',
      'hitBox': 'var(--color-hitBox)',
    ...
    extend: {width: {'fc': 'fit-content'}, height: {'fc': 'fit-content'}, minHeight: {'fc': 'fit-content'}},
  },
  ...
  plugins: [
    function({ addUtilities, addVariant }) {
      ...
      // Direction variants: usage -> rtl:text-right, ltr:text-left, etc.
