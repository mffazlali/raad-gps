...
export class SwitcherControl {
  ...
  updateStyles(updatedStyles, defaultStyle, manualStyle = '') {
  ...
  hidStyles(){
    this.styleButton.classList.add('maplibregl-style-switcher-hidden')
    // this.styleButton.style.display = 'none'
  }

  showStyles(){
    this.styleButton.classList.remove('maplibregl-style-switcher-hidden')
    // this.styleButton.style.display = 'none'
  }
