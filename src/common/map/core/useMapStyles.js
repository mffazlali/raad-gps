...
export const styleCustom = ({tiles, minZoom, maxZoom, attribution}) => {
  const source = {
    type: 'raster',
    tiles,
    attribution,
  ...
  return {
    ...
    glyphs: `/fonts/map/{fontstack}/{range}.pbf`,
...
export default () => {
  ...
  const mapboxAccessToken = 'pk.eyJ1Ijoicm9iZXJ0c21pdGhtYiIsImEiOiJjamtuc3FjNGYxZDR4M3dtZ3FqbGpudzllIn0.L_uIqdhg6sdPwfoYJEbU_w'
  ...
  const mapURL = import.meta.env.VITE_APP_APN_MAP_URL
  ...
  return [
    ...
    // },
    {
      ...
      title: t('mapOsm'),
      style: styleCustom({
        tiles: [isAPN ? `${mapURL}/tile/{z}/{x}/{y}.png` : 'https://tile.openstreetmap.org/{z}/{x}/{y}.png'],
        maxZoom: 19,
        attribution:
          isAPN ? `© <a target="_top" rel="noopener" href="${mapURL}">OpenStreetMap</a> contributors` : '© <a target="_top" rel="noopener" href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',
      }),
      available: true,
    },
    {
    ...
    },
    {
      ...
      available: isAPN ? false : !!mapTilerKey,
      attribute: !!mapTilerKey,
    },
    {
      id: 'mapTilerStreets',
      title: t('mapTilerStreets'),
    ...
    },
    {
      ...
      available: isAPN ? false : !!bingMapsKey,
    ...
    },
    {
      ...
      available: isAPN ? false : !!tomTomKey,
      attribute: 'tomTomKey',
    },
    {
      id: 'hereBasic',
    ...
    },
    {
      ...
      available: isAPN ? false : !!mapboxAccessToken,
      attribute: 'mapboxAccessToken',
    },
    {
      id: 'mapboxTrafficDay',
      title: t('mapboxTrafficDay'),
      style: styleCustom({
        tiles: [
          `https://api.mapbox.com/styles/v1/mapbox/traffic-day-v2/tiles/{z}/{x}/{y}?access_token=${mapboxAccessToken}`,
        ],
        maxZoom: 22,
      }),
      available: isAPN ? false : !!mapboxAccessToken,
    ...
    {
      id: 'mapboxTrafficNight',
      title: t('mapboxTrafficNight'),
      style: styleCustom({
        tiles: [
          `https://api.mapbox.com/styles/v1/mapbox/traffic-night-v2/tiles/{z}/{x}/{y}?access_token=${mapboxAccessToken}`,
        ],
        maxZoom: 22,
      }),
      available: isAPN ? false : !!mapboxAccessToken,
    ...
    },
    {
      ...
      available: isAPN ? false : !!customMapUrl,
    },
    {
      id: 'arcgisonline',
      title: t('mapArcgisonline'),
      style: styleCustom({
        tiles: ['https://services.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer/tile/{z}/{y}/{x}.png'],
        maxZoom: 19,
        attribution:
          '© <a target="_top" rel="noopener" href="https://services.arcgisonline.com">OpenStreetMap</a> contributors',
      }),
      available: !isAPN || false,
    },
  ]
}
