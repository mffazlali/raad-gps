...
object && object.hasOwnProperty(key) && object[key] !== null

export const usePreference = (key, defaultValue=null) =>
  useSelector((state) => {
...
export const useAttributePreference = (key, defaultValue=null) =>
  useSelector((state) => {
    if (state.session.server?.forceSettings) {
